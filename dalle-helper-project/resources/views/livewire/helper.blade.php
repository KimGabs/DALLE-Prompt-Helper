    ...
    <form-section>
        ...
        <div class="rounded-lg border border-gray-200 shadow-md px-7 py-8 mt-8">
            ...
            <div class="flex justify-center">
                <button type="button" id="copyButton" class="mt-3 w-full justify-center inline-flex rounded-md  border-2 border-yellow-500 shadow-sm px-4 py-2 text-base bg-white font-bold text-yellow-500 hover:bg-yellow-500 hover:text-white sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">Copy to Clipboard</button>
