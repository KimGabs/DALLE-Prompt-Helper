<x-app-layout>
    <div class="min-h-screen flex flex-col">
        <div class="w-full text-left py-6">
            <h1 class="text-xl font-bold subpixel-antialiased">Edit Parameter</h1>
        </div>
        ...
        @endif
            ...
            <form action="{{ route('parameters.update', $parameter->id) }}" method="POST" class="max-w-lg mx-auto" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-5">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name:</label>
                    <input type="text" name="name" id="name" value="{{ old('name', $parameter->name) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    @if($parameter->image)
                        <div class="py-4">
                            <img src="../..{{ Storage::url($parameter->image) }}" alt="Current Image" width="400">
                        </div>
                    @endif
                </div>
                <div class="mb-5">
                    <label for="text_color" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Text Color:</label>
                    <input type="text" name="text_color" id="text_color" value="{{ old('text_color', $parameter->text_color) }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
                </div>
                {{-- <div class="mb-5">
