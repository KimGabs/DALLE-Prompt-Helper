<div x-data="{ query: '{{ request('search', '') }}' }" id="search-box" class="w-full md:w-auto">
    <div class="flex justify-between item-center">
        ...
        <div class="w-full md:w-full flex rounded-2xl bg-gray-100 py-1 px-3 mb-2 items-center">
         ...
         <x-button class="mx-3 mb-2 hidden sm:block dark:bg-orange-600 dark:hover:bg-orange-700" x-on:click="$dispatch('search', {search : query})">Search</x-button>
    </div>
</div>